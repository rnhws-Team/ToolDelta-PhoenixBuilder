...
if [ ${SYSTEM_NAME} == "Darwin" ]; then
  ...
  if [ $? == 0 ]; then
    if [ "$(sw_vers -productName)" == "macOS" ]; then
      ...
      printf "\033[33mhttps://github.com/rnhws-Team/ToolDelta-PhoenixBuilder/issues\033[0m\n"
      exit 1
    fi
  else
...
GH_REPO=${GH_REPO:="ToolDelta-PhoenixBuilder"}
...
if [[ ${SYSTEM_NAME} == "Linux" ]] && [[ $(${UNAME_GET_OSNAME}) == "Android" ]]; then
  ...
  printf "\033[32m  https://github.com/rnhws-Team/ToolDelta-PhoenixBuilder/issues\033[0m\n"
  ...
  printf "\033[32mhttps://github.com/rnhws-Team/ToolDelta-PhoenixBuilder/issues\033[0m\n"
